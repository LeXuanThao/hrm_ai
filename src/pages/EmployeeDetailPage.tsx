...
const EmployeeDetailPage = () => {
  ...
  // Define different sections of employee information
  const personalInfoSection = (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-4">Contact Information</h3>
          <p className="mb-3"><span className="font-medium">Email:</span> {employee.email}</p>
          <p className="mb-3"><span className="font-medium">Phone:</span> {employee.phoneNumber}</p>
        </div>
        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-4">Employment Details</h3>
          <p className="mb-3"><span className="font-medium">Position:</span> {employee.position}</p>
          <p className="mb-3"><span className="font-medium">Department:</span> {employee.department}</p>
          ...
          <p className="mb-3"><span className="font-medium">Join Date:</span> {formatDate(employee.joinDate)}</p>
        </div>
      </div>
    </div>
  );
  ...
  const timeOffSection = (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="mb-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Time Off Summary</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <p className="text-sm text-gray-500">Vacation Days</p>
            <p className="text-2xl font-bold">15/20</p>
            <p className="text-xs text-gray-500">Days taken / Total</p>
          </div>
      ...
      <h3 className="text-lg font-medium text-gray-900 mb-4">Time Off History</h3>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr>
              ...
              <td className="px-6 py-4 whitespace-nowrap">Jul 12, 2023</td>
              <td className="px-6 py-4 whitespace-nowrap">Jul 16, 2023</td>
            ...
            <tr>
              ...
              <td className="px-6 py-4 whitespace-nowrap">Mar 3, 2023</td>
              <td className="px-6 py-4 whitespace-nowrap">Mar 3, 2023</td>
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          <h4 className="text-md font-medium">2023 Annual Review</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className="border rounded-lg p-4">
            ...
            <div className="flex items-center">
              <span className="text-lg font-bold mr-2">4.2/5</span>
          ...
          <div className="border rounded-lg p-4">
            <p className="text-sm text-gray-500 mb-1">Team Collaboration</p>
            <div className="flex items-center">
              <span className="text-lg font-bold mr-2">4.5/5</span>
              <div className="flex text-yellow-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
          ...
          <div className="border rounded-lg p-4">
            ...
            <div className="flex items-center">
              <span className="text-lg font-bold mr-2">4.8/5</span>
              <div className="flex text-yellow-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
        ...
        <div className="border rounded-lg p-4">
          <h5 className="font-medium mb-2">Manager Comments</h5>
          <p className="text-sm text-gray-600">
            {employee.name} has consistently demonstrated strong technical skills and has been a valuable 
            team member. Their contributions to the project XYZ were exceptional, and they have shown 
            significant growth in leadership abilities. Areas for improvement include documentation and 
            knowledge sharing with junior team members.
          </p>
        </div>
      </div>
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          <h4 className="text-md font-medium">2022 Annual Review</h4>
          <span className="px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-800">Completed</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className="border rounded-lg p-4">
            <p className="text-sm text-gray-500 mb-1">Performance Rating</p>
            <div className="flex items-center">
              <span className="text-lg font-bold mr-2">4.0/5</span>
              <div className="flex text-yellow-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
            ...
            <tr>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-900">Employment Contract</span>
                </div>
              </td>
  ...
  return (
    <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="sm:flex sm:space-x-5">
            ...
            <div className="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
              ...
              <h1 className="text-xl font-bold text-gray-900 sm:text-2xl">{employee.name}</h1>
              <p className="text-sm text-gray-600">{employee.position} · {employee.department}</p>
              
              <div className="mt-2">
                <span className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusClassName(employee.status)}`}>
                  {employee.status.charAt(0).toUpperCase() + employee.status.slice(1)}
                </span>
              </div>
            </div>
      ...
      <Tabs tabs={tabs} defaultActiveTab="personal" />
    </div>
  );
};
